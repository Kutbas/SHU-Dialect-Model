...
key_xf_app_id = 'eaef8c6b'
key_xf_api_key ='7c524ce1a5d0fd7edcb7232c26a0c023'
key_xf_api_secret = 'YmZjYWI5NDMwOGM3ODJlZjZiNTU2MTA1'
key_ms_tts_key = None
...
def load_config():
    ...
    key_xf_app_id = system_config.get('key', 'xf_app_id')
    key_xf_api_key = system_config.get('key', 'xf_api_key')
    key_xf_api_secret = system_config.get('key', 'xf_api_secret')
